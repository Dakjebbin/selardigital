...
<div class="max-w-sm w-full bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6">
  <div class="flex justify-between mb-5">
    <div class="grid gap-4 grid-cols-2">
      <div>
        <h5 class="inline-flex items-center text-gray-500 dark:text-gray-400 leading-none font-normal mb-2">Total Users
        ...
        <p class="text-gray-900 dark:text-white text-2xl leading-none font-bold">{users.length}</p>
      </div>
      {/* <div>
